...
hard-fork: ## Hard fork chain
	@HARDFORK_BLOCK_HEIGHT=397040 NEW_GENESIS_TIME='2024-02-28T22:03:14.896497921Z' CHAIN_ID='hermeschain-stagenet' VIA_URL=true HARDFORK_URL=https://storage.googleapis.com/hermes-node-hard-fork/stagenet/genesis.397040_3.json IMAGE='asia-south1-docker.pkg.dev/prod-dojima/stagenet/hermes:b875f73c_5.4.9' ./scripts/hard-fork.sh
