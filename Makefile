...
hard-fork-testnet: ## hard fork testnet
	@HARDFORK_BLOCK_HEIGHT=657599 NEW_GENESIS_TIME='2024-12-29T05:11:49.897790136Z' CHAIN_ID='h4s-184-d11k' VIA_URL=true HARDFORK_URL="https://dojimachain1401.blob.core.windows.net/2024-12-29/genesis.21.modified.json" IMAGE='testnet1.azurecr.io/hermes:5d40cad1_1.0.0' ./scripts/hard-fork.sh
